...
/// Variable Cart Item Widget
///
/// Renders a single variable product cart item with a premium design.
/// Shows: product name, variation values, quantity, line price.
class VariableCartItem extends ConsumerWidget {
  final CartItem item;

  const VariableCartItem({super.key, required this.item});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemTotal =
        item.lineTotalAfter ?? item.salePrice ?? item.regularPrice ?? 0.0;
                      ...
                      children: [
                        ...
                        if (item.variationValues != null &&
                          ...
                          Wrap(
                            spacing: 8,
                            runSpacing: 4,
                            children: item.variationValues!.expand((
                              variationMap,
                            ) {
                        ...
                        else if (item.variationName != null &&
